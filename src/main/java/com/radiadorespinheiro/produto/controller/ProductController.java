package com.radiadorespinheiro.produto.controller;


import com.radiadorespinheiro.produto.dto.ProductPatchRequest;
import com.radiadorespinheiro.produto.dto.ProductRequest;
import com.radiadorespinheiro.produto.dto.ProductResponse;
import com.radiadorespinheiro.produto.service.ProductService;
...
public class ProductController {
    ...
    @Operation(summary = "Find all Products", description = "find a products")
     @GetMapping ResponseEntity<List<ProductResponse>> findAll() {
